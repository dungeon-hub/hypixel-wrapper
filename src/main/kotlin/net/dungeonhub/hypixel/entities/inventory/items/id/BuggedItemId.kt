...
enum class BuggedItemId(override val apiName: String, override val itemClass: (SkyblockItem) -> SkyblockItem) :
    ...
    NullSand2("SAND:9"),
    NullDirt("DIRT:9"),
    NullLeatherBoots1("LEATHER_BOOTS:30", { Armor(it.raw) }),
    NullLeatherBoots2("LEATHER_BOOTS:40", { Armor(it.raw) }),
    NullLeatherBoots3("LEATHER_BOOTS:42", { Armor(it.raw) }),
    NullLeatherBoots4("LEATHER_BOOTS:48", { Armor(it.raw) }),
    NullLeatherBoots5("LEATHER_BOOTS:58", { Armor(it.raw) }),
    NullBow("BOW:96"),
    NullStone("STONE:9"),
